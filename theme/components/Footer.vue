...
if (theme.value.umami) {
  ...
  const getData = async () => {
    ...
    if (total?.pageviews)
      count.value = total.pageviews.value;
  };
...
<template>
  <div class="home-footer">
    <div class="flex" @click="jumpTo">
      <svg
        t="1718900204155" class="icon" :fill="isDark ? '#8B8B8B' : '#7F7F7F'" viewBox="0 0 1024 1024" version="1.1"
    ...
    <div class="flex">
      <svg
        t="1718900068559" class="icon" :fill="isDark ? '#8B8B8B' : '#7F7F7F'" viewBox="0 0 1024 1024" version="1.1"
    ...
    <div v-if="count" class="flex">
      <svg
        t="1718899204675" class="icon" :fill="isDark ? '#8B8B8B' : '#7F7F7F'" viewBox="0 0 1024 1024" version="1.1"
        xmlns="http://www.w3.org/2000/svg" p-id="4263" width="20" height="20"
      >
        <path d="M508 512m-112 0a112 112 0 1 0 224 0 112 112 0 1 0-224 0Z" p-id="4264" />
        <path
