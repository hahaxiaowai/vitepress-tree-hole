...
<template>
  <div v-if="show" :class="active ? 'btn active' : 'btn'" @click="backTop">
    <svg
      t="1722062582377" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
